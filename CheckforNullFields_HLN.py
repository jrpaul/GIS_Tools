"""--------------------------------------------------------------------------------
CheckforNullFields_HLN.py

Description:
Check parcel feature classes for empty hyperlink and layout number fields
...
parcelFields = ['LayoutNo', 'Hyperlink']

# Set the progressor
arcpy.SetProgressor("step", "Checking fields...", 0, parcel_count, 1)

with open(outTXT, 'w') as txtfile:
    txtfile.write("Parcels with nulls in hyperlink or layout number field" + "\n")
